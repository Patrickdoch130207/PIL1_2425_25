...
urlpatterns=[
    ...
    path('matching_trajets/<int:id>/', views.matching_trajets, name='matching_trajets'),
    ...
    path('gerer_reservations/', views.gerer_reservations, name='gerer_reservations'),
    path('traiter_reservation/<int:reservation_id>/<str:action>/', views.traiter_reservation, name='traiter_reservation'),
]
